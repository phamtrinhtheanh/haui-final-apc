...
<body class="bg-light">
<nav class="navbar navbar-expand-lg navbar-dark bg-dark" style="background: #111827 !important;">
    <div class="container d-flex justify-content-between">
        <a class="navbar-brand" href="{{ url('/') }}">
            <svg viewBox="0 0 316 316" fill="white" xmlns="http://www.w3.org/2000/svg" style="color: #9ca3af">
                <path
...
<main class="container mt-4">
    ...
    <div class="container mt-4">
        ...
        @endif
        @php($users = collect(range(1, 2))->map(function ($i) {
                return (object) [
                    'id' => $i,
                    'name' => "User $i",
                    'email' => "user$i@example.com",
                    'roles' => collect([(object) ['name' => 'User']]),
                ];
            }))
            ...
            @foreach ($users as $user)
                <tr class="align-items-bottom">
                    ...
                    <td>
                        ...
                        <button class="btn-transparent btn-svg-danger">
